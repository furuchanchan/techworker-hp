...
- 経営者が「自社をよく分かっている」と感じる、具体的で示唆に富む内容にする。スコアの高低の意味を読み解き、最も成果に効く一手を一点に絞って示す。誇張・空虚な美辞麗句は避け、必ず回答スコアに紐づける。
...
2) 診断結果に基づく「御社の状況」を経営者向けに4〜5文で。①現在地（Microsoftの成熟度の言葉で）②相対的な強み ③最大のボトルネック（最も成果に効く一手）を、スコアの高低の意味を読み解いて具体的に。読んだ経営者が「次に何をすべきか腹落ちする」レベルまで踏み込む。会社固有の未確認事実は書かない。
